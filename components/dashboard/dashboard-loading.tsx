// Skeleton for the dashboard shape rendered by DashboardView - shared by
// app/loading.tsx (the authenticated `/` dashboard) and
// app/shared/[token]/loading.tsx (the read-only share-link view, which
// renders the exact same DashboardView component - see CLAUDE.md's "Read-only
// share links" section for why those two routes must never drift apart).
