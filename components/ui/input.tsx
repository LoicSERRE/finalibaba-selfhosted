    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ref={ref}
          id={inputId}
          className={`w-full min-h-[44px] px-3 py-2 rounded-lg bg-[var(--surface-elevated)] border ${
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ref={ref}
          id={selectId}
          className={`w-full min-h-[44px] px-3 py-2 rounded-lg bg-[var(--surface-elevated)] border border-[var(--border)] text-sm text-[var(--foreground)] outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent)]/30 transition-colors cursor-pointer ${className}`}
          {...props}
        >
          {options.map((o) => (
